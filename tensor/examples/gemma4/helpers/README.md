...
execution. They do not establish full-model equivalence. Historical full-model numerical investigations are retained in the [dated Gemma4 report](../../../experiments/history/2026-09-15-gemma4-xnnpack-readme.md). They do not establish results for the current consolidated build.
