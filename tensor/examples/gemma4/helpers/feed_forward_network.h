...
//
// Keep the Gemma-specific projections here: the generic FeedForward helper does
// not consume the mobile checkpoint's fixed activation quantization scales.
// Pass the checkpoint weights to preserve those scales at all three
// projections.
//
