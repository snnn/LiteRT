...
Earlier model runs, phone commands and numerical investigations are preserved in the [historical Gemma4 report](../../experiments/history/2026-09-15-gemma4-xnnpack-readme.md). Those measurements describe their recorded revisions and are not results for this consolidated build.
