...
struct SoftmaxOptions : public OpOptions {
  ...
  Expected<void> SetOpOptions(LiteRtBuilder builder) {
    LITERT_RETURN_IF_ERROR(
        LiteRtBuilderBuildSoftmaxOpOption(builder, op, &beta));
    return Expected<void>();
  }
};
...
struct DepthwiseConv2dOptions : public OpOptions {
  ...
  LiteRtStatus InitFromOp(LiteRtOp op) override {
    ...
    LITERT_RETURN_IF_ERROR(
        LiteRtGetDepthwiseConv2dStrideWOption(op, &stride_w));
    LITERT_RETURN_IF_ERROR(
        LiteRtGetDepthwiseConv2dStrideHOption(op, &stride_h));
    LITERT_RETURN_IF_ERROR(
...
struct L2Pool2dOptions : public OpOptions {
  ...
  LiteRtStatus InitFromOp(LiteRtOp op) override {
    ...
    LITERT_RETURN_IF_ERROR(
        LiteRtGetL2Pool2dFilterWidthOption(op, &filter_width));
    LITERT_RETURN_IF_ERROR(
...
struct SpaceToDepthOptions : public OpOptions {
  ...
  LiteRtStatus InitFromOp(LiteRtOp op) override {
    ...
    LITERT_RETURN_IF_ERROR(
        LiteRtGetSpaceToDepthBlockSizeOption(op, &block_size));
    this->op = op;
...
struct DepthToSpaceOptions : public OpOptions {
  ...
  LiteRtStatus InitFromOp(LiteRtOp op) override {
    ...
    LITERT_RETURN_IF_ERROR(
        LiteRtGetDepthToSpaceBlockSizeOption(op, &block_size));
    this->op = op;
